  ...
  return (
    <div className="relative flex items-center justify-center w-ful mx-5  md:h-screen count md:pt-10 timeline lg:px-2 gap-6 xl:ml-5 mb-5 pb-16">
      <div className="absolute inset-y-0 inset-x-0 left-0 z-40 flex items-center w-2/3 md:w-full rocket xl:mr-3 lg:ml-7">
        ...
        <img loading="lazy" className="absolute z-25 scale-[110%] 2xl:max-w-[1900px] md:translate-y-[115px]" alt="hero" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/landscapepanjang.png?raw=true" />
      </div>
      <div className="relative z-40 md:items-center md:flex">
        <div className="flex items-center justify-center w-full text-center text-white">
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-7xl md:px-12 py-6 font-bold font-audiowide md:px-10 bg-[#8c8c8c]/20 backdrop-blur-lg border-white border-[4px] md:leading-relaxed lg:leading-relaxed sm:leading-relaxed text-border-white text-gray-300 rounded-2xl">Bedah Kampus</h1>
        </div>
