    ...
    <div className="relative flex items-center justify-center w-ful mx-5  md:h-screen count md:pt-10 timeline lg:px-2 gap-6 xl:ml-5 mb-5 pb-16">
      ...
      <div className="relative z-40 md:items-center md:flex">
        <div className="flex items-center justify-center w-full text-center text-white">
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-7xl md:px-6 py-10 font-bold font-audiowide md:px-10 bg-[#8c8c8c]/20 backdrop-blur-lg border-white border-[4px] md:leading-relaxed lg:leading-relaxed sm:leading-relaxed text-border-white text-gray-300 rounded-2xl">Bedah Kampus</h1>
        </div>
