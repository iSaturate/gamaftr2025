    ...
    <div className="relative flex items-center justify-center w-ful mx-5  md:h-screen count md:pt-10 timeline lg:px-2 gap-6 xl:ml-5 mb-5 pb-16">
      ...
      <div className="relative z-40 md:items-center md:flex">
        <div className="flex items-center justify-center w-full text-center text-white">
          <h1 className="text-3xl font-bold font-audiowide md:px-10 sm:text-7xl md:text-7xl lg:text-7xl xl:text-7xl bg-[#8c8c8c]/20 backdrop-blur-lg border-white border-[4px] md:leading-relaxed lg:leading-relaxed sm:leading-relaxed text-border-white text-gray-300 rounded-2xl">Bedah Kampus</h1>
        </div>
