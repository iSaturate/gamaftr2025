...
const Cardsmall = () => {
  ...
  <div className="relative flex flex-col items-center px-8 mt-2 pt-36 md:top-36 lg:w-1/3 md:mt-12">
    ...
    <img loading="lazy" className="absolute translate-x-[-200px] translate-y-[-200px] md:hidden w-[15%] h-auto" alt="hero" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/ball1.png?raw=true" />
