...
const Cardsmall = () => {
  ...
  return (
    ...
    <div className="relative z-40 flex justify-center p-2 text-3xl md:text-8xl xl:text-8xl lg:text-8xl font-extrabold leading-normal text-grey-300 bg-[#8c8c8c]/20  text-shadow-white font-audiowide backdrop-blur-lg temb-2 border-[4px] border-white md:leading-relaxed rounded-xl lg:text-border-white">TICKET</div>
