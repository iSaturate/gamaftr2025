...
const Cardsmall = () => {
  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row mx-auto min-h-screen items-center justify-center bg-[#FFFFFFF]/0 gap-4 xl:pt-60 md:pb-12 lg:my-[10px] relative">
      ...
      <div className="relative z-40 text-5xl font-audiowide font-extrabold text-gray-300 leading-normal bg-[#8c8c8c]/20 shadow-white rounded-2xl border-[4px] border-white backdrop-blur-lg shadow-white lg:text-border-white backdrop-blur-lg shadow-xl xl:text-8xl p-4 lg:py-0 xl:p-4 pl-10mr-[180px]" >TICKET</div>
