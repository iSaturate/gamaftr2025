...
const Cardsmall = () => {
  ...
  return (
    ...
    <div className="relative z-40 flex justify-center p-2 text-8xl md:text-8xl font-extrabold leading-normal  bg-[#8c8c8c]/20  shadow-white font-audiowide backdrop-blur-lg shadow-white temb-2 xl:text-8xl lg:text-8xl border-[4px] border-white md:leading-relaxed rounded-xl lg:text-border-white">TICKET</div>
