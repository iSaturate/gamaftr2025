...
const Cardsmall = () => {
  ...
  return (
    ...
    <div className="relative z-40 flex justify-center p-2 text-5xl md:text-8xl font-extrabold leading-normal text-grey-900 bg-[#8c8c8c]/20  text-shadow-white font-audiowide backdrop-blur-lg temb-2 xl:text-8xl lg:text-8xl border-[4px] border-white md:leading-relaxed rounded-xl lg:text-border-white">TICKET</div>
          ...
          <div className="absolute inset-0 z-40 p-8 bg-[#061328] rounded-xl">
            ...
            <img loading="lazy" src="https://github.com/SyaidFarhan/Gamaftr/blob/main/Gamaft/1704419489494.jpg?raw=true" alt="Shoes" className='md:max-w-[350px] rounded-xl shadow-[0px_0px_20px_#F8F37B]' />
              ...
              <div className="dropdown dropdown-right md:mt-2">
                <button onClick={handleClick} className="border-3 text-white border-space2 hover:hover:shadow-[0px_0px_20px_#F8F37B] hover:border-space2 hover:bg-white hover:text-space2 btn btn-primary bg-space2"><a className='font-bold font-outfit'>Daftar</a></button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative w-full h-full transition-all duration-500 scale-90 shadow-xl">
          <div className="absolute inset-0 z-40 p-8 bg-[#061328] rounded-xl">
            ...
            <img loading="lazy" src="https://github.com/SyaidFarhan/Gamaftr/blob/main/Gamaft/1704419489494.jpg?raw=true" alt="Shoes" className='md:max-w-[350px] shadow-[0px_0px_20px_#F8F37B] rounded-xl' />
              ...
              <div className="dropdown dropdown-right md:mt-2">
                 <button onClick={handleClick} className="border-3 text-white hover:hover:shadow-[0px_0px_20px_#F8F37B] border-space2 hover:bg-space1 hover:text-space2 btn btn-primary bg-space2"><a className='font-bold font-outfit'>Daftar</a></button>
              </div>
              </div>
