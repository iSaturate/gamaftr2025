...
const Ticket = () => {
  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row mx-auto min-h-screen items-center justify-center bg-[#FDD134] gap-4 xl:pt-60 md:pb-12 lg:my-[10px] relative">
      ...
      <div className="text-5xl font-spacegrotesk font-extrabold text-white rounded-2xl border-[4px] border-space1 bg-[#7DBEF8] shadow-xl shadow-space1 xl:text-8xl p-4 lg:py-0 xl:p-4 pl-10mr-[180px] relative z-40 text-border-space1 ">TICKET</div>
