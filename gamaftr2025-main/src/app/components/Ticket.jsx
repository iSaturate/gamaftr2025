...
const Ticket = () => {
  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row mx-auto min-h-screen items-center justify-center bg-[#FDD134] gap-4 xl:pt-60 md:pb-12 lg:my-[10px] relative">
       <img loading="lazy" className="absolute z-10 lg:-translate-x-[40px] scale-[100%] 2xl:max-w-[1900px] md:translate-y-[300px]" alt="hero" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/Banner.png?raw=true" />


      <div className="text-5xl font-spacegrotesk font-extrabold text-white rounded-2xl border-[4px]  bg-[#205FC9] shadow-xl  xl:text-8xl p-4 lg:py-0 xl:p-4 pl-10mr-[180px] relative z-40  ">TICKET</div>
        ...
        <div className=" lg:mb-0 xl:mb-8 sm:mb-1 md:mb-1">
            ...
            <ul>
              ...
              <div className="mt-auto space-y-4 ">
                ...
                <button onClick={handleClick} className="border-none text-white shadow-[0px_0px_20px_#205FC9] hover:bg-white hover:text-blue-600 btn btn-primary bg-[#205FC9]"><a className='font-bold font-spacegrotesk'>Daftar</a></button>
