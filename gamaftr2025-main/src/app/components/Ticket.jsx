...
const Ticket = () => {
  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row mx-auto min-h-screen items-center justify-center bg-[#FDD134] gap-4 xl:pt-60 md:pb-12 lg:my-[10px] relative">
      ...
      <div className="text-5xl font-spacegrotesk font-extrabold text-white rounded-2xl border-[4px] border-space1 bg-[#205FC9] shadow-xl  xl:text-8xl p-4 lg:py-0 xl:p-4 pl-10mr-[180px] relative z-40  ">TICKET</div>
        ...
        <div className=" lg:mb-0 xl:mb-8 sm:mb-1 md:mb-1">
            ...
            <ul>
              ...
              <div className="mt-auto space-y-4 ">
                ...
                <button onClick={handleClick} className="border-none text-space2 shadow-[0px_0px_20px_#FDD134] hover:bg-blue-950 hover:text-white btn btn-primary bg-space1"><a className='font-bold font-spacegrotesk'>Daftar</a></button>
        ...
        <div
          ...
          <div className="absolute z-40 inset-0 h-full w-full rounded-xl bg-[#7DBEF8]  p-8 [transform:rotateY(180deg)] [backface-visibility:hidden]" id='ticketweb'>
            ...
            <ul>
              ...
              <button onClick={handleClick} className="border-none text-white shadow-[0px_0px_20px_#FDD134] hover:bg-white hover:text-space2 btn btn-primary bg-blue-600"><a className='font-bold font-spacegrotesk'>Daftar</a></button>
              </div>
            </div>
          </div>
        </div>
