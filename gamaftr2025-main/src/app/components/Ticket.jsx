...
const Ticket = () => {
  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row mx-auto min-h-screen items-center justify-center gap-4 xl:pt-60 md:pb-12 lg:my-[10px] relative">
      ...
      <img loading="lazy" className="absolute z-15 lg:-translate-x-[40px] scale-[100%] 2xl:max-w-[1900px]  md:translate-y-[-960px]" alt="hero" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/citylandscape.png?raw=true" />
