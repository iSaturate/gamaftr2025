        ...
        <div className=" lg:mb-0 xl:mb-8 sm:mb-1 md:mb-1">
            ...
            <ul>
              ...
              <div className="mt-auto space-y-4 ">
                ...
                <button onClick={handleClick} className="border-none text-white shadow-[0px_0px_20px_#205FC9] hover:bg-white hover:text-blue600 btn btn-primary bg-[#205FC9]"><a className='font-bold font-spacegrotesk'>Daftar</a></button>
