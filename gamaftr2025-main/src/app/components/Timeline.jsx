              ...
              <div className="flex flex-row-reverse items-center justify-between w-full mb-8 left-timeline">
                ...
                <img 
                 src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cube1.png?raw=true" className='absolute z-10 transition-transform scale-150 animate-random2' />
                  <p className="relative z-40 flex justify-center mb-3 text-base text-white md:text-lg lg:text-2xl md:ml-1 lg:ml-7 md:mr-10 leading-normal bg-[#8c8c8c]/20 shadow-white font-outfit backdrop-blur-lg border-[4px] border-white md:leading-relaxed rounded-2xl mt-10">5 Januari 2025</p>
