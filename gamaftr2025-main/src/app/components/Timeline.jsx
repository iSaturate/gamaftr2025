              ...
              <div className="flex flex-row-reverse items-center justify-between w-full mb-8 left-timeline">
                ...
                <img 
                 src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cube1.png?raw=true" className='absolute z-10 transition-transform scale-150 animate-random2' />
                  <p className="flex justify-center mb-3 text-base text-white md:text-lg lg:text-2xl md:mr-16 lg:mx-7 lg:ml-7 leading-normal bg-[#8c8c8c]/20 translate-y-[450px] shadow-white font-outfit backdrop-blur-lg border-[4px] border-white md:leading-relaxed rounded-2xl">5 Januari 2025</p>
