            ...
            <div className="relative h-full md:-translate-x-[50px] lg:-translate-x-[0px] ">
              ...
              <div className="flex items-center justify-between w-full mb-8 right-timeline">
                ...
                <img 
                 src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cube1.png?raw=true" alt="" className='absolute z-40 transition-transform animate-random1' />
                  ...
                  <h4 className="flex justify-center mb-3 text-white text-lg font-semiboldt xl:text-6xl md:text-2xl sm:text-lg lg-text-5xl md:ml-[60px] lg:mx-7 leading-normal bg-[#8c8c8c]/20 shadow-white font-outfit backdrop-blur-lg border-[4px] border-white md:leading-relaxed rounded-2xl">Roadshow</h4>
                </div>
              </div>
              <div className="flex flex-row-reverse items-center justify-between w-full mb-8 left-timeline">
                <div className="order-1 w-5/12"></div>
              ...
              <div className="relative z-40 flex items-center justify-between w-full mb-8 right-timeline">
                ...
                <div className="relative z-40 order-1 w-5/12 px-1 py-4">
                  ...
                  <h4 className="flex justify-center mb-3 text-white text-lg font-semibold text-left xl:text-6xl md:text-2xl sm:text-lg lg-text-5xl md:ml-[60px] lg:mx-7 leading-normal bg-[#8c8c8c]/20 shadow-white font-outfit backdrop-blur-lg border-[4px] border-white md:leading-relaxed rounded-2xl">Bedah Kampus</h4>
                </div>
              </div>
            </div>
          </div>
