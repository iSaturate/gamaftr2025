              ...
              <div className="flex flex-row-reverse items-center justify-between w-full mb-8 left-timeline">
                ...
                <img 
                 src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cube1.png?raw=true" className='absolute z-10 transition-transform scale-150 animate-random2' />
                  <p className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-40 flex justify-center p-2 text-xl md:text-3xl font-extrabold leading-normal bg-[#8c8c8c]/20 shadow-white font-audiowide backdrop-blur-lg shadow-white temb-2 xl:text-6xl lg:text-5xl border-[4px] border-white md:leading-relaxed rounded-2xl lg:text-border-white">5 Januari 2025</p>
