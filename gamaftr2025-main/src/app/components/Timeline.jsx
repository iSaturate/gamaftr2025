            ...
            <div className="relative h-full md:-translate-x-[50px] lg:-translate-x-[0px] ">
              ...
              <div className="flex flex-row-reverse items-center justify-between w-full mb-8 left-timeline">
                ...
                <div className="order-1 w-5/12 text-right lg:px-1 lg:py-4">
                  <p className="z-10 flex justify-center mb-3 text-base text-white md:text-lg lg:text-2xl md:mr-16 lg:mx-7 lg:ml-7 leading-normal bg-[#8c8c8c]/20 translate-y-[450px] shadow-white font-outfit backdrop-blur-lg border-[4px] border-white md:leading-relaxed rounded-2xl">18-19 Januari 2025</p>
