            ...
            <div className="relative h-full md:-translate-x-[50px] lg:-translate-x-[0px] ">
              <div className="flex flex-row-reverse items-center justify-between w-full mb-8 left-timeline">
                ...
                <div className="relative z-40 order-1 w-5/12 text-right lg:px-1 lg:py-4">
                  {/* <img src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cube1.png?raw=true" className='absolute z-10 bottom-[-750px] scale-150 animate-random2' />*/}
                  ...
                  <img 
                 src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cube1.png?raw=true" className='absolute z-10 bottom-[-750px] scale-150 animate-random2' />
                </div>
              </div>
              <div className="flex items-center justify-between w-full mb-8 right-timeline">
                ...
                <div className="relative z-40 order-1 w-5/12 text-left lg:px-1 lg:py-4">
                  <img 
                 src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/plane1.png?raw=true" alt="" className='absolute z-10 bottom-[-725px] transition-transform animate-random1' />
