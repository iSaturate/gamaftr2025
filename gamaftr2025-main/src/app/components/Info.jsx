...
const Info = () => {
  return (
    <div className="w-full lg:pt-10 md:pt-60 xl:pt-60" id='info1'>
     ...
     <img loading="lazy" className="absolute z-20 -translate-y-[2000px] scale-[90%] -translate-x-3  sm:scale-[80%] overflow-x-hidden" alt="hero" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/inikeretapi.png?raw=true" />
    </div>
  );
};
