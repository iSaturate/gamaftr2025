    ...
    <div className="w-full lg:pt-10 md:pt-60 xl:pt-60" id='info1'>
      <div className="md:hidden relative z-40 my-20  ">
        ...
        <div className="relative w-full bg-[#d3d3d3]/60 rounded-3x1 backdrop-blur-lg p-4 translate-y-[200px]">
          ...
          <img loading="lazy" className="absolute z-5 object-cover object-center duration-100 max-w-[100px] vm:max-w-[200px] lg:max-w-[200px] md:max-w-[200px] sm:max-w-[100px] left-1/2 bottom-[300px] transform -translate-x-1/2 -translate-y-1/2" alt="hero" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/Group%20146.png?raw=true" />
