    ...
    <div className="w-full lg:pt-10 md:pt-60 xl:pt-60" id='info1'>
      <div className="md:hidden relative z-40 my-20  ">
        <div className="relative w-full px-4 pt-5 text-center text-white">
          <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/Cloud.png?raw=true" alt="Alt Text" style="top: 50px;" className='animate-cloud-move sm:animate-cloud-move-sm md:animate-cloud-move-md lg:animate-cloud-move-lg absolute z-10 -translate-x-10'/>
      ...
      <div className="hidden md:flex items-center justify-center h-screen p-4 md:pt-80  mx-auto gap-20 2xl:container about relative">
        ...
        <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/Cloud.png?raw=true" alt="" className="absolute z-10 translate-x-[248px] xl:translate-y-[-900px] md:translate-y-[-600px] lg:translate-y-[-430px] xl:scale-[75%] md:scale-[50%] sm:scale-[80%] lg:scale-[60%] hidden md:block " />
        ...
        <img loading="lazy" className="absolute z-0 -translate-y-[30px] scale-[100%] -translate-x-3 w-[110%]  sm:scale-[110%] overflow-x-hidden" alt="hero" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/inikeretapi.png?raw=true" />
      </div>
