  ...
  return (
    <div className="w-full lg:pt-10 md:pt-60 xl:pt-60" id='info1'>
      ...
      <div className="hidden md:flex items-center justify-center h-screen p-4 md:pt-80  mx-auto gap-20 2xl:container about relative">
        ...
        <img loading="lazy" className="absolute z-20 -translate-y-[30px] scale-[130%] -translate-x-3  sm:scale-[120%] overflow-x-hidden" alt="hero" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/inikeretapi.png?raw=true" />
      </div>
