...
const Footer = () => {
  ...
  <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/Gamaft/logogamaftr2025%20(2).png?raw=true" alt="" className="max-w-[60px] md:max-w-[150px] md:pl-4 pl-1 ml-3" />
    <p className='text-sm font-bold text-white lg:block md:pt-6 lg:text-lg font-audiowide'>Gadjah Mada <br className='text-sm'/>Flies To Riau 2025<br />©IT GAMAFTR </p>
  ...
  <nav className=''>
    <div className="flex gap-6 scale-50 md:translate-y-0 md:grid md:grid-flow-col md:gap-6 md:scale-100">
      <a href='https://www.tiktok.com/@gamaftr'> <svg
      viewBox="0 0 24 24"
      fill="currentColor"
      height="50"
      width="50"
    ...
    >
      ...
      <a href='https://www.youtube.com/@GadjahMadaFliestoRiau'><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" className="mb-4 fill-current"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"></path></svg></a>
      <a href='https://www.instagram.com/gamaftr/'><svg
      viewBox="0 0 24 24"
      fill="currentColor"
      height="50"
      width="50"
