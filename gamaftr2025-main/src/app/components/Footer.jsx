...
const Footer = () => {
  return (
    ...
    <footer className="flex p-2 md:items-center sm:justify-between gap-[10px] md:gap-[40px] md:p-10 md:rounded-full shadow-2xl footer bg-[39D81E8]/20 text-space1 shadow-red-700 md:scale-100 md:px-36 relative z-40">
