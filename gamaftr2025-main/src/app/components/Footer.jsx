...
const Footer = () => {
  ...
  <img loading="lazy" src="https://raw.githubusercontent.com/iSaturate/gamaftrfoto/main/gamaftrfoto/Gamaft/Logo_Institut_Teknologi_Bandung.png?raw=true" alt="" className="max-w-[60px] md:max-w-[150px] md:pl-4 pl-1 ml-3" />
