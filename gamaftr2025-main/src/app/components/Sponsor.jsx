...
const Sponsor = () => {
    return (
       <div className="relative z-50 h-full px-[10%] md:px-[14px] lg:px-20 xl:px-[59px] pt-[60px] mb-5 2xl:pt-[60px] overflow-hidden">
        ...
        <div className="relative z-50 grid content-center justify-center h-full">
            <div className=" relative w-full text-center xl:max-[1260px] font-spacegrotesk overflow-hidden">
                ...
                <div className=" max-w-[120px] md:max-w-[220px] p-[5%]">
                    <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/AGUNG%20TOYOTA%20min.png" alt="hero" className="" />
                </div>
                ...
                <div className="hidden max-w-[70px] md:max-w-[170px] p-[5%]">
                    ...
                    {/* medpart */}
                    <div className="gap-5 px-2 pb-5 mb-2 text-center scale-[80%] bg-white/40 sm:scale-100 rounded-2xl">
  ...
  <div className="flex items-center justify-center gap-5">
    ...
    <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/Logi baru rri pku.png?raw=true" alt="" className=" w-9 h-9" />
  </div>

  {/* Second Row */}
  <div className="flex items-center justify-center gap-5 mt-3">
    <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/RiauGoodId.jpg?raw=true" alt="" className="w-9 h-9" />
