       ...
       <div className="relative z-50 h-full px-[10%] md:px-[14px] lg:px-20 xl:px-[59px] pt-[60px] mb-5 2xl:pt-[60px] overflow-hidden">
        ...
        <div className="relative z-50 grid content-center justify-center h-full">
            <div className=" relative w-full text-center xl:max-[1260px] font-spacegrotesk overflow-hidden">
                ...
                <div className="text-4xl  font-audiowide font-extrabold text-white rounded-2xl bg-[#d3d3d3]/40 backdrop-blur-md max-w-2/3 xl:text-8xl p-6 lg:py-0 xl:p-4 pl-10mr-[180px] relative z-40">Our Partners</div>
                </div>
                ...
                <div className=" max-w-[70px] md:max-w-[170px] p-[5%]">
                    ...
                    {/* medpart */}
                    <div className="gap-5 px-2 pb-5 mb-2 text-center scale-[80%] bg-[#F1723D]/50 sm:scale-100 rounded-2xl">
  <h1 className="flex items-center justify-center text-lg font-bold text-center font-audiowide text-space1 text-yellow-200">Media Partner</h1>
