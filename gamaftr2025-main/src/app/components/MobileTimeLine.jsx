...
const MobileTimeline = () => {
  return (
    <div className="py-4 text-white md:hidden">
      ...
      <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/themobilekereta.png?raw=true" alt="Alt Text" className='absolute z-10 flex justify-center translate-x-[-10] translate-y-20 md:hidden'/>
