...
const MobileTimeline = () => {
  return (
    <div className="py-4 text-white md:hidden">
      ...
      <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/mobiletrain.png?raw=true" alt="Alt Text" className='absolute z-10 flex justify-center translate-x-10 translate-y-20 md:hidden'/>
        <div className="px-[60PX] md:w-1/2 md:px-8 relative">
          <div className="flex justify-center">
        
        </div>
        <div className="text-5xl font-audiowide font-extrabold text-white backdrop-blur-lg rounded-2xl border-[4px] border-white backdrop-blur-lg shadow-white temb-2 xl:text-8xl py-4 pl-10mr-[180px] relative z-40 text-border-white text-center">TIMELINE</div>
        </div>
