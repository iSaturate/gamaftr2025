  ...
  return (
    <div className="py-4 text-white bg-[#FFC100] md:hidden">
      ...
      <img loading="lazy" src="https://github.com/SyaidFarhan/Gamaftr/blob/main/image/marsbig.png?raw=true" alt="Alt Text" className='absolute z-10 translate-x-10 translate-y-20 md:hidden'/>
        ...
        <div className="text-5xl font-spacegrotesk font-extrabold text-white rounded-2xl border-[4px] border-space2 bg-[#7DBEF9] shadow-xl shadow-space2 xl:text-8xl py-4 pl-10mr-[180px] relative z-40 text-border-space2 text-center">TIMELINE</div>
        </div>
