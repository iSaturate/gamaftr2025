...
const Lokasi = () => {
  return (
   <div className="relative z-30 flex justify-center mx-auto pt-36 md:mt-5 font-inter" id='event'>
    ...
    <div className="relative"><img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cylinder2.png?raw=true" alt="" className="overflow-hidden rotate-[100deg] translate-y-[50px] translate-x-[270px] md:hidden w-[57%] h-auto" /> </div>
    <div className="relative"><img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cylinder2.png?raw=true" alt="" className="overflow-hidden rotate-[100deg] translate-y-[-70px] translate-x-[240px] md:hidden w-[55%] h-auto" /> </div>
    <div className="relative"><img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/plane1.png?raw=true" alt="" className="overflow-hidden rotate-[45deg] translate-y-[-280px] translate-x-[50px] md:hidden w-[55%] h-auto" /> </div>
