  ...
  return (
   <div className="relative z-30 flex justify-center mx-auto pt-36 md:mt-5 font-inter" id='event'>
    ...
    <div className="relative">
      <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/ball1.png?raw=true" alt="" className="animate-spiral animate-random2 translate-y-[150px] translate-x-[50px] md:hidden w-[10%] h-[10%]" /> </div>
    <div className="relative">
