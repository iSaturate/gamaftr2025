...
{/*     <div className="relative"><img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/ball1.png?raw=true" alt="" className="bottom-[30px] md:hidden w-[25%] h-auto animate-spiral" /> </div> */}
  ...
  <div>
    <img
      ...
      alt=""
      className="absolute z-[-1] object cover bottom-[30px] md:hidden w-[25%] h-auto animate-spiral"
    />
  </div>
  <div>
    <img
      ...
      alt=""
      className="absolute z-[-1] object cover translate-y-[-100px] translate-x-[100px] md:hidden w-[100%] h-auto"
    />
  </div>
  <div>
    <img
