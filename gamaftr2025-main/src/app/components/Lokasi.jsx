...
const Lokasi = () => {
  return (
   <div className="relative z-30 flex justify-center mx-auto pt-36 md:mt-5 font-inter" id='event'>
    ...
    <div className="relative">
      <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/plane3.png?raw=true" alt="" className="animate-random2 rotate-270 translate-y-[49px] translate-x-[600px] md:hidden w-[30%] h-[30%]" /> </div>
    <div className="relative">
      <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/CloudDouble.png?raw=true" alt="" className="translate-y-[50px] translate-x-[50px] md:hidden w-[100%] h-[100%]" /> </div>
