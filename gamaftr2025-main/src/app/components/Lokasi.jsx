...
const Lokasi = () => {
  return (
   <div className="relative z-30 flex justify-center mx-auto pt-36 md:mt-5 font-inter" id='event'>
    ...
    <div className="sm:border-[3px] sm:shadow-[0px_0px_20px_#F1723D] sm:bg-red-400 sm:shadow-space2 sm:border-space2 sm:rounded-full  relative z-40 md:-translate-y-[100px] lg:-translate-y-[200px] max-w-[1280px]">
