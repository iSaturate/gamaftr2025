...
const Lokasi = () => {
  return (
   <div className="relative z-30 flex justify-center mx-auto pt-36 md:mt-5 font-inter" id='event'>
    ...
    <div className="md:w-1/2 md:px-8 sm:hidden scale-100 text-7xl font-audiowide font-bold text-gray-300 rounded-2xl bg-[#8c8c8c]/20 backdrop-blur-md shadow-xl shadow-space2 text-border-white xl:text-8xl backdrop-blur-lg p-4 lg:py-0 xl:p-4 pl-10mr-[180px] relative z-40 text-center">EVENTS</div>
