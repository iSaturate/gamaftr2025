...
const Lokasi = () => {
  return (
   <div className="relative z-30 flex justify-center mx-auto pt-36 md:mt-5 font-inter" id='event'>
    ...
    <div className="relative"><img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/ball1.png?raw=true" alt="" className="translate-y-[600px] translate-x-[500px] md:hidden w-[25%] h-auto" /> </div>
    ...
    <div className="relative"><img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cylinder2.png?raw=true" alt="" className="rotate-[100deg] translate-y-[180px] translate-x-[300px] md:hidden w-[60%] h-auto" /> </div>
    <div className="relative"><img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cylinder2.png?raw=true" alt="" className="rotate-[100deg] translate-y-[50px] translate-x-[200px] md:hidden w-[57%] h-auto" /> </div>
    <div className="relative"><img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cylinder2.png?raw=true" alt="" className="rotate-[100deg] translate-y-[-60px] translate-x-[100px] md:hidden w-[55%] h-auto" /> </div>
    <div className="relative overflow-hidden"><img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/plane1.png?raw=true" alt="" className="rotate-[45deg] translate-y-[-280px] translate-x-[100px] md:hidden w-[55%] h-auto" /> </div>
