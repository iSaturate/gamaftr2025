...
{/*     <div className="relative"><img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/ball1.png?raw=true" alt="" className="bottom-[30px] md:hidden w-[25%] h-auto animate-spiral" /> </div> */}
  ...
  <div>
    <img
      ...
      alt=""
      className="absolute inset-0 z-[-1] z-10 bottom-[30px] md:hidden w-[25%] h-auto animate-spiral"
    />
  </div>
  <div>
    <img
      ...
      alt=""
      className="absolute inset-0 z-[-1] z-10 translate-y-[-100px] translate-x-[100px] md:hidden w-[100%] h-auto"
    />
  </div>
  <div>
    <img
      ...
      alt=""
      className="absolute inset-0 z-[-1] z-10 rotate-[100deg] translate-y-[180px] translate-x-[330px] md:hidden w-[60%] h-auto"
    />
  </div>
  <div>
    <img
      ...
      src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cylinder2.png?raw=true"
      alt=""
      className="absolute inset-0 z-[-1] z-10 rotate-[100deg] translate-y-[50px] translate-x-[230px] md:hidden w-[57%] h-auto"
    />
  </div>
  <div>
    <img
      ...
      src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/cylinder2.png?raw=true"
      alt=""
      className="absolute inset-0 z-[-1] z-10 rotate-[100deg] translate-y-[-60px] translate-x-[130px] md:hidden w-[55%] h-auto"
    />
  </div>
  <div>
    <img
      ...
      alt=""
      className="absolute inset-0 z-[-1] z-10 rotate-[45deg] translate-y-[-290px] translate-x-[20px] md:hidden w-[49%] h-auto"
    />
  </div>
  <div>
    <img
      ...
      alt=""
      className="absolute inset-0 z-[-1] z-10 translate-y-[50px] translate-x-[30px] md:hidden w-[100%] h-auto"
    />
  </div>
</div>
