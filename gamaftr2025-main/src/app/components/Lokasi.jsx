...
<div className="overflow-hidden">
  <div>
    <img
      ...
      alt="hero"
      className="absolute inset-0 z-10 translate-y-[-80px] translate-x-[100px] md:hidden w-[100%] h-auto"
    />
  </div>
  <div>
    <img
      ...
      alt="hero"
      className="absolute inset-0 z-[-1] translate-y-[-130px] translate-x-[30px] md:hidden w-[100%] h-auto"
    />
  </div>
</div>
    <h1 className="hidden sm:pt-10  text-3xl font-extrabold text-gray-300 sm:text-center sm:flex sm:justify-center rounded-x1 font-audiowide md:text-5xl text lg:text-7xl md:pt-5 text-border-white">RANGKAIAN ACARA</h1>
...
<div className="mt-5 transition shadow-xl card card-compact sm:w-1/2 w-50 md:w-70 lg:[50%] xl:[20%] hover:scale-125 hover:z-40 hover:shadow-lg hover:shadow-space2 bg-space2">
  ...
  <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-space1 text-white hover:text-white rounded-box w-52 font-outfit">
