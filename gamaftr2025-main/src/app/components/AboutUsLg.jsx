...
const AboutUsLg = () => {
  ...
  <div className="px-4 mx-auto xl:mb-12 max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24" id='aboutus'>
    <div className="relative items-center mx-auto max-w-8xl">
      ...
      <img loading="lazy" className="cloud-move-x sm:cloud-move-x-sm md:cloud-move-x-md lg:cloud-move-x-lg absolute z-50 object-cover object-center duration-100 max-w-[200px] vm:max-w-[300px] lg:max-w-[300px] lg:translate-x-[800px] md:translate-x-[700px] sm:translate-x-[700px] md:max-w-[400px]  translate-x-[700px] sm:max-w-[100px] md:translate-y-[100px] lg:-translate-y-[250px] opacity-50" alt="hero" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/Cloud.png?raw=true" />

      <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/Cloud.png?raw=true" alt="Alt Text" className='cloud-move-x sm:cloud-move-x-sm md:cloud-move-x-md lg:cloud-move-x-lg absolute z-0 -translate-y-[10px] 2xl:-translate-x-[400px] -translate-x-[200px] Edit:-translate-x-[280px] float-left
