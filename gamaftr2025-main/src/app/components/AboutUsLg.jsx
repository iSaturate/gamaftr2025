...
const AboutUsLg = () => {
  ...
  <div className="px-4 mx-auto xl:mb-12 max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24" id='aboutus'>
    <div className="relative items-center mx-auto max-w-8xl">
      ...
      <img loading="lazy" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/Cloud.png?raw=true" alt="Alt Text" className='absolute z-0 -translate-y-[10px] 2xl:-translate-x-[400px] -translate-x-[200px] Edit:-translate-x-[280px] float-left
