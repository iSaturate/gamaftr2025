...
const AboutUsLg = () => {
  ...
  <div className="px-4 mx-auto xl:mb-12 max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24" id='aboutus'>
    <div className="relative items-center mx-auto max-w-8xl">
      ...
      <img loading="lazy" className="absolute z-5 object-cover object-center duration-100 max-w-[200px] vm:max-w-[300px] lg:max-w-[300px] lg:translate-x-[800px] md:translate-x-[700px] sm:translate-x-[700px] md:max-w-[400px] translate-x-[700px] sm:max-w-[100px] bottom-[350px]" alt="hero" src="https://github.com/iSaturate/gamaftrfoto/blob/main/gamaftrfoto/Group%20146.png?raw=true" />
      ...
      <a href="https://docs.google.com/forms/d/e/1FAIpQLScXFRlX1OBAINBC4OZZuw9QVVFlz_loqLcidOCD4xqtEsT8-g/viewform?usp=dialog" className="px-6 py-2 font-extrabold transition duration-300 md:hidden rounded-xl text-white bg-space2 hover:bg-white hover:text-space2 font-outfit hover:shadow-[0px_0px_20px_#205FC9] relative z-50">Order Ticket</a>
      </div>
