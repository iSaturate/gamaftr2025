...
const AboutUsLg = () => {
  ...
  <div className="px-4 mx-auto xl:mb-12 max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24" id='aboutus'>
    <div className="relative items-center mx-auto max-w-8xl">
      ...
      <img loading="lazy" className="relative object-cover object-center duration-100 lg:scale-125 animate-pulse animate-glow lg:pt-18" alt="hero" src="https://github.com/SyaidFarhan/Gamaftr/blob/main/image/Property%201=Variant2.png?raw=true" />
      <div className="flex justify-center">
      <img loading="lazy" className="relative object-cover  sm:max-w-[400px] object-center max-w-[290px] md:max-w-[600px] lg:max-w-[400px]  lg:pt-5 flex justify-center" alt="hero" src="https://github.com/SyaidFarhan/Gamaftr/blob/main/Gamaft/An%20Aviation%20to%20limitless%20future%20(1).png?raw=true" />
      </div>
      ...
      <a href="https://bit.ly/SALEGAMAFTR2024" className="px-6 py-2 font-extrabold transition duration-300 md:hidden bg-yellow-400 rounded-xl text-space1 hover:bg-space1 hover:text-space2 font-spacegrotesk hover:shadow-[0px_0px_20px_#FFC100] relative z-50">Order Ticket</a>
      </div>
      ...
      {/* <img loading="lazy" src="https://github.com/SyaidFarhan/Gamaftr/blob/main/image/image%201.png?raw=true" alt="Alt Text" className='relative z-20 scale-[150%] -translate-x-10 md:hidden'/> */}
      </div>
    </div>
  </div>
</section>
