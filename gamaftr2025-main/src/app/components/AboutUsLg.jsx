...
const AboutUsLg = () => {
  ...
  <div className="px-4 mx-auto xl:mb-12 max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24" id='aboutus'>
    <div className="relative items-center mx-auto max-w-8xl">
      ...
      <a href="https://bit.ly/PRE-SALE2GAMAFTR2025" className="px-6 py-2 font-extrabold transition duration-300 md:hidden rounded-xl text-white bg-space2 hover:bg-white hover:text-space2 font-outfit hover:shadow-[0px_0px_20px_#205FC9] relative z-50">Order Ticket</a>
      </div>
