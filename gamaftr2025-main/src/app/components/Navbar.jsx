      ...
      <div className="px-4 mx-auto max-w-7xl">
        <div className="flex justify-between">
          ...
          <div className="items-center hidden gap-5 space-x-1 md:flex">
            ...
            <a href="https://bit.ly/SALEGAMAFTR2024" className="px-6 py-2 font-extrabold transition duration-300 bg-green-600 rounded-3xl text-space1 hover:bg-space1 hover:text-space2 font-spacegrotesk hover:shadow-[0px_0px_20px_#31AFAB]">Order Ticket</a>
          </div>
