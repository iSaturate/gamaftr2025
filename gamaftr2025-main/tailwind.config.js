...
module.exports = {
  ...
  theme: {
    extend: {
     ...
     animation: {
        "cloud-move" : "cloud-move-x 18s linear infinite",
        "cloud-move-sm" : "cloud-move-x-sm 18s linear infinite",
        "cloud-move-md" : "cloud-move-x-md 18s linear infinite",
        "cloud-move-lg" : "cloud-move-x-lg 18s linear infinite",
      }
    },
  },
  plugins: [
