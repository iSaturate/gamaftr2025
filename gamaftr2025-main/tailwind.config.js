...
module.exports = {
  ...
  theme: {
    extend: {
     ...
     animation: {
        "cloud-move" : "cloud-move-x 10s linear infinite",
        "cloud-move-sm" : "cloud-move-x-sm 10s linear infinite",
        "cloud-move-md" : "cloud-move-x-md 10s linear infinite",
        "cloud-move-lg" : "cloud-move-x-lg 10s linear infinite",
      }
    },
  },
  plugins: [
