...
module.exports = {
  ...
  theme: {
    extend: {
     ...
     animation: {
        "cloud-move" : "cloud-move-x 25s linear infinite",
        "cloud-move-sm" : "cloud-move-x-sm 25s linear infinite",
        "cloud-move-md" : "cloud-move-x-md 25s linear infinite",
        "cloud-move-lg" : "cloud-move-x-lg 25s linear infinite",
      }
    },
  },
  plugins: [
